...
<html xmlns="http://www.w3.org/1999/xhtml">
                        ...
                        <div id="logo">
                            <ul id="nav">
                               <li><a href="home.jsp">Dashboard</a></li>
                                ...
                                <li id="current"><a href="checkout.jsp">CheckOut</a></li>
	...
	<center>
	 ...
	 <div id="stylized" class="myform">
        ...
        <form action="checkoutActioin.jsp">
        
        <h1>Check Out Form<br/><br/></h1>
        
        <label>Transaction ID      
	   <span class="small">Paypal Transaction</span></label> 
	   <input type="text" name="transactionid" id="transactionid" size="30"/> <br/> <br/>
        
        
        <input type="submit"  value="Check Out" style="margin-left: 90px"/>
