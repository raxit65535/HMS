...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<display:column  title="Accept"  sortable="true" media="html"><a href="ConformBooking.jsp?${data.id}">Conform</a> </display:column>
    <display:column  title="Reject"  sortable="true" media="html"><a href="RejectBooking.jsp?${data.id}">Reject </a></display:column>
