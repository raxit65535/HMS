...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="../search_mycustomer.do">
				<select name="search">
			<option value="..."   >...</option>
	...
	<display:caption><h3>my customers</h3></display:caption>
    ...
    <display:setProperty name="export.excel.filename" value="mycustomer.xls"/>
    <display:setProperty name="export.pdf.filename" value="mycustomer.pdf"/>
